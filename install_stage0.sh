...
echo "  Next steps:"
echo ""
echo "  1) Build and configure (~15-20 min, stay at the terminal):"
echo ""
echo "     cd $INSTALL_DIR/$REPO_NAME"
echo "     srun --pty --mem=8G --time=01:00:00 --cpus-per-task=2 ./apptainer/setup.sh"
echo ""
echo "  2) Activate the openclaw command (one-time setup):"
echo ""
echo "     echo 'module use ~/modulefiles' >> ~/.bashrc && source ~/.bashrc"
