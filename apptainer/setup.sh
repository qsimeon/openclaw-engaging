...
echo ""
echo "  1) Submit the gateway job:"
echo ""
echo "     sbatch $SCRIPT_DIR/slurm-gateway.sh"
echo ""
echo "  2) Check the output for your SSH tunnel command + dashboard URL:"
echo ""
echo "     squeue -u \$USER"
echo "     cat openclaw-gw-<jobid>.out"
echo ""
echo "  3) On your laptop, run the SSH tunnel (copy from job output):"
echo ""
echo "     ssh -f -N -L 18790:<node>:18790 \$(whoami)@<login-node>"
echo ""
echo "     (-f backgrounds the tunnel so you keep your terminal)"
echo ""
echo "  4) Open the dashboard URL from the job output in your browser."
echo ""
...
echo "    module load apptainer/1.4.2"
echo "    apptainer exec $SIF_FILE openclaw agent --local --agent main"
echo ""
echo "  Batch job:"
